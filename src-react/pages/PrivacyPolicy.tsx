      ...
      <div className="legal-container">
        ...
        <section>
          ...
          <p>
            ...
            <strong>Domy</strong>, con sede legale in Italia.
          </p>
          <p>
            Email di contatto:{" "}
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              password (criptata), numero di telefono
            </li>
            <li>
              <strong>Dati per i fornitori:</strong> codice fiscale, partita
              IVA, IBAN, indirizzo, documenti di identità
            </li>
            <li>
              <strong>Dati di pagamento:</strong> elaborati da Stripe (non
              memorizziamo i dati delle carte)
            </li>
          </ul>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Contratto:</strong> necessario per fornire il servizio
            </li>
            <li>
              <strong>Consenso:</strong> per comunicazioni di marketing (se
              fornito)
            </li>
            <li>
              <strong>Obbligo legale:</strong> per adempimenti fiscali e
              normativi
            </li>
            <li>
              <strong>Interesse legittimo:</strong> per sicurezza e prevenzione
              frodi
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Cloudinary:</strong> per l'archiviazione sicura dei
              documenti
            </li>
            <li>
              <strong>Brevo (Sendinblue):</strong> per l'invio di email
            </li>
            <li>
              <strong>Google:</strong> per OAuth e Google Maps
            </li>
            <li>
              <strong>Sentry:</strong> per il monitoraggio degli errori (dati
              anonimi)
            </li>
            <li>
              <strong>Autorità competenti:</strong> se richiesto dalla legge
            </li>
          </ul>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Dati account:</strong> fino alla cancellazione
              dell'account
            </li>
            <li>
              <strong>Dati fiscali:</strong> 10 anni (obbligo di legge)
            </li>
            <li>
              <strong>Log di sicurezza:</strong> 12 mesi
            </li>
            <li>
              <strong>Documenti fornitori:</strong> fino a 5 anni dopo la
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Opposizione:</strong> opporti al trattamento per marketing
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            aggiornamento. Per modifiche sostanziali, ti invieremo una notifica.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Hai anche il diritto di presentare reclamo al Garante per la
