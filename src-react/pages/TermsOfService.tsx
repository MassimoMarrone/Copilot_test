    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <section>
          ...
          <p>
            Utilizzando la piattaforma Domy, accetti di essere vincolato da questi 
            Termini e Condizioni. Se non accetti questi termini, non puoi utilizzare il servizio.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Domy è una piattaforma online che mette in contatto clienti con fornitori 
            di servizi di pulizia professionale. Domy agisce come intermediario e non 
            è direttamente responsabile della prestazione dei servizi.
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li><strong>Cliente:</strong> può prenotare servizi di pulizia</li>
            <li><strong>Fornitore:</strong> può offrire servizi dopo approvazione</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>I fondi sono trattenuti in escrow fino al completamento del servizio</li>
            <li>Accettiamo carte di credito/debito tramite Stripe</li>
          </ul>

          <h3>4.3 Cancellazioni</h3>
          <ul>
            <li><strong>Più di 24 ore prima:</strong> rimborso completo</li>
            <li><strong>Meno di 24 ore:</strong> rimborso del 50%</li>
        ...
        <section>
          ...
          <ul>
            <li>Domy trattiene una commissione del 15% su ogni servizio completato</li>
            <li>Il pagamento viene rilasciato entro 5 giorni lavorativi dal completamento</li>
          </ul>

          <h3>5.4 Sospensione</h3>
          <p>
            Domy si riserva il diritto di sospendere o terminare l'account del fornitore in caso di:
          </p>
          <ul>
        ...
        <section>
          ...
          <ol>
            ...
            <li>Il fornitore completa il servizio e carica prova fotografica</li>
        ...
        <section>
          <h2>7. Recensioni</h2>
          <ul>
            <li>I clienti possono lasciare recensioni dopo il completamento del servizio</li>
            <li>Le recensioni devono essere oneste e basate sull'esperienza reale</li>
            <li>Domy si riserva il diritto di rimuovere recensioni false o offensive</li>
        ...
        <section>
          ...
          <p>
            Si consiglia ai fornitori di avere un'assicurazione RC professionale.
            I clienti sono invitati a verificare la copertura assicurativa del fornitore.
          </p>
        </section>
        ...
        <section>
          ...
          <ol>
            ...
            <li>La decisione di Domy è finale per quanto riguarda i rimborsi</li>
          </ol>
        </section>
        ...
        <section>
          ...
          <p>
            Domy può modificare questi termini in qualsiasi momento. 
            Le modifiche saranno comunicate via email o notifica sulla piattaforma.
        ...
        <section>
          ...
          <ul>
            <li>Email: <a href="mailto:support@domy.it">support@domy.it</a></li>
